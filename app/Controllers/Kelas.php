...
class Kelas extends BaseController
{
    ...
    public function nilai($id_kelas)
    {
        ...
        // nama file (untuk download / save as)
        $namaFile = 'Rapot_P3MP_' . preg_replace('/[^A-Za-z0-9_\-]/', '_', $namaKelas) . '.pdf';
        ...
        $data = [
            ...
            'namaKelas'  => $namaKelas, // ⬅️ penting untuk title
    ...
    // Biodata Rapot
    public function printbiodata($id_kelas)
    {
        $kelas = $this->ModelKelas->getNamaKelas($id_kelas);
        $namaKelas = $kelas ? $kelas['kelas'] : 'kelas';
    ...
    public function halaman($id_kelas)
    {
        ...
        $kelas = $this->ModelKelas->getNamaKelas($id_kelas);
        $namaKelas = $kelas ? $kelas['kelas'] : 'kelas';
        $namaFile = 'HalamanDepan_Rapot_Kelas_' . preg_replace('/[^A-Za-z0-9_\-]/', '.', $namaKelas) . '.pdf';
    ...
    public function label($id_kelas)
    {
        ...
        $kelas = $this->ModelKelas->getNamaKelas($id_kelas);
        $namaKelas = $kelas ? $kelas['kelas'] : 'kelas';
        $namaFile = 'Label_Rapot_Kelas_' . preg_replace('/[^A-Za-z0-9_\-]/', '.', $namaKelas) . '.pdf';
