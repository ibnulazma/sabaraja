...
class Peserta extends BaseController
{
    ...
    public function kartu_keluarga($id_siswa)
    {
        $berkas = new ModelPeserta();
        $data = $berkas->DataPeserta($id_siswa);
    ...
    public function updateijazah($id_siswa)
    {
        if ($this->validate([
    ...
    public function update_kk($id_siswa)
    {
        if ($this->validate([
    ...
    public function updateakte($id_siswa)
    {
        if ($this->validate([
    ...
    public function masukkelas($id_siswa)
    {
        $db     = \Config\Database::connect();
    ...
    public function printmohon($id_siswa)
    {
        $options = new Options();
        ...
        $data = [
            'keluar'         => $this->ModelPeserta->permohonan($id_siswa),
        ...
        $html = view('admin/peserta/surat_pindah', $data);
        //Atur Gambar
