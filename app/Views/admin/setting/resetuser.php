    ...
    <div class="nav-align-top nav-tabs-shadow mt-4">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="navs-justified-home" role="tabpanel">
                ...
                <div class="mt4">
                    <?= csrf_field(); ?>
                    <button type="button" id="btnResetUser" class="btn btn-warning mt-2">
                        🔐 Reset Password User
                    </button>
                </div>
            </div>
            <div class="tab-pane fade" id="navs-justified-profile" role="tabpanel">
                <div class="mt-4">
                    ...
                    <table class="table table-stripped" id="tbluserguru">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Nama</th>
            ...
            <div class="tab-pane fade" id="navs-justified-siswa" role="tabpanel">
                ...
                <table class="table table-stripped" id="tblresetsiswa">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Nama</th>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (toggle) {
            toggle.addEventListener("change", function() {
                fetch("<?= base_url('admin/setting/toggle-maintenance') ?>")
...
<script>
    ...
    document.getElementById('btnResetSiswa').addEventListener('click', function() {
        resetBatch("<?= base_url('admin/setting/reset-password-siswa') ?>", "Reset semua password siswa?");
    });

    document.getElementById('btnResetGuru').addEventListener('click', function() {
        resetBatch("<?= base_url('admin/setting/reset-password-guru') ?>", "Reset semua password guru?");
    });
</script>
    ...
    document.getElementById('formResetGuru').addEventListener('submit', function(e) {
        ...
        Swal.fire({
            ...
            function prosesBatch() {
                fetch("<?= base_url('admin/setting/reset-password-guru') ?>", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/x-www-form-urlencoded",
                            "X-Requested-With": "XMLHttpRequest"
