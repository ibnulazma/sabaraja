                        ...
                        <div class="col-md-12">
                            <div class="nav-align-top">
                                <ul class="nav nav-pills flex-column flex-md-row mb-4">
                                    <li class="nav-item"><a class="nav-link <?= $submenu == 'anggotarombel' ? 'active' : '' ?>" href="<?= base_url('pendidik/rombel') ?>"><i class="bx bx-sm bx-user-circle me-1_5"></i> Anggota Rombel</a></li>
                                    <li class="nav-item"><a class="nav-link <?= $submenu == 'nilai' ? 'active' : '' ?>" href="<?= base_url('pendidik/nilai') ?>"><i class="bx bx-sm bxs-report me-1_5"></i> Nilai</a></li>
                                    <li class="nav-item"><a class="nav-link <?= $submenu == 'periodik' ? 'active' : '' ?>" href="pages-account-settings-connections.html"><i class="bx bx-sm bx-link-alt me-1_5"></i> Connections</a></li>
                                </ul>
                            </div>
                        </div>
